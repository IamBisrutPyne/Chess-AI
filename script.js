  ...
  randomMove() {
    if (this.active) {
      ...
      const positions = ids
        ...
        .filter((position) =>
          position === null || position === void 0 ? void 0 : position.active
        );
  ...
  drawPositions(moves, captures) {
    moves === null || moves === void 0
      ...
      : moves.forEach(({ row, col }) => {
          ...
          (_b = this.pieces[
            (_a = this.game.board.tileFind({ row, col })) === null ||
            _a === void 0
              ? void 0
              : _a.data.id
          ]) === null || _b === void 0
            ? void 0
            : _b.classList.add("highlight-move");
        });
    captures === null || captures === void 0
      ...
      : captures.forEach(({ row, col, capture }) => {
          ...
          (_b = this.pieces[
            ...
            ? void 0
            : _b.classList.add("highlight-capture");
        });
  }
  drawResetClassNames() {
    document
